...
\begin{tikzpicture}
  \fill[red!20]   (90:1.2)  circle (2.5);
  \fill[blue!20]  (210:1.2) circle (2.5);
  \fill[green!20] (330:1.2) circle (2.5);

  \draw[thick] (90:1.2)  circle (2.5);
  \draw[thick] (210:1.2) circle (2.5);
  \draw[thick] (330:1.2) circle (2.5);
